    ...
    def __init__(self):
        ...
        self.test_cases = [
            ...
            },
            {
                ...
                'args': (
                    (50, [10, 20, 30], [60, 100, 120], 3),
                    (150, [random.randint(1, 50) for _ in range(30)], [random.randint(1, 100) for _ in range(30)], 30),
                    (160, [random.randint(1, 50) for _ in range(32)], [random.randint(1, 100) for _ in range(32)], 32)
                )
            },
            {
                'name': 'Coin Change',
            ...
            },
            {
                ...
                'args': (
                    ("kitten", "sitting"),
                    ("intenteony", "executionl"),
                    ("anticaracter", "antimatters")
                )
            },
            {
                'name': 'Factorial',
            ...
            },
            {
                ...
                'args': (
                    (1, 8, [random.randint(5, 50) for _ in range(11)]),
                    (1, 12, [random.randint(5, 50) for _ in range(17)]),
                    (1, 14, [random.randint(5, 50) for _ in range(25)])
                )

            },
            {
                'name': 'Can I Win',
                'func_normal': can_i_win, 
                'func_memo': can_i_win_memo,  
                'args': (
                    (10, 11),
                    (18, 35),
                    (20, 45)
            ...
            },
            {
                ...
                'func_normal': can_partition_k_subsets,
                'func_memo': can_partition_k_subsets_memo,  
                'args': (
                    ([5]*16, 4),
                    ([5, 5, 5, 5, 10, 10, 10, 10, 15, 15, 15, 15, 20, 20, 20, 20, 25, 25, 25, 25, 30, 30, 30, 30,
                      5, 5, 5, 5, 10, 10, 10, 10, 15, 15, 15, 15, 20, 20, 20, 20, 25, 25, 25, 25, 30, 30, 30, 30,
                      5, 5, 5, 5, 10, 10, 10, 10, 15, 15, 15, 15, 20, 20, 20, 20, 25, 25, 25, 25, 30, 30, 30, 30, 
                      35, 35, 35, 35, 40, 40, 40, 40, 45, 45, 45, 45, 50, 50, 50, 50, 55, 55, 55, 55, 60, 60, 60, 60,
                      35, 35, 35, 35, 40, 40, 40, 40, 45, 45, 45, 45, 50, 50, 50, 50, 55, 55, 55, 55, 60, 60, 60, 60,
                      35, 35, 35, 35, 40, 40, 40, 40, 45, 45, 45, 45, 50, 50, 50, 50, 55, 55, 55, 55, 60, 60, 60, 60,
                      5, 5, 5, 5, 10, 10, 10, 10, 15, 15, 15, 15, 20, 20, 20, 20, 25, 25, 25, 25, 30, 30, 30, 30,
                      5, 5, 5, 5, 10, 10, 10, 10, 15, 15, 15, 15, 20, 20, 20, 20, 25, 25, 25, 25, 30, 30, 30, 30,
                    ...
                    ([10, 10, 10, 10, 20, 20, 20, 20, 30, 30, 30, 30, 40, 40, 40, 40, 
                        ...
                        10, 10, 10, 10, 20, 20, 20, 20, 30, 30, 30, 30, 40, 40, 40, 40, 
                        50, 50, 50, 50, 60, 60, 60, 60, 70, 70, 70, 70, 80, 80, 80, 80,  
                        90, 90, 90, 90, 100, 100, 100, 100, 110, 110, 110, 110, 120, 120, 
                        120, 120, 130, 130, 130, 130, 140, 140, 140, 140, 150, 150, 150, 150, 
                        160, 160, 160, 160, 170, 170, 170, 170, 180, 180, 180, 180, 190, 190, 
                        190, 190, 200, 200, 200, 200, 90, 90, 90, 90, 100, 100, 100, 100, 110, 110, 110, 110, 120, 120, 
                        120, 120, 130, 130, 130, 130, 140, 140, 140, 140, 150, 150, 150, 150, 
                        160, 160, 160, 160, 170, 170, 170, 170, 180, 180, 180, 180, 190, 190, 
                        190, 190, 200, 200, 200, 200, 90, 90, 90, 90, 100, 100, 100, 100, 110, 110, 110, 110, 120, 120, 
                        120, 120, 130, 130, 130, 130, 140, 140, 140, 140, 150, 150, 150, 150, 
                        160, 160, 160, 160, 170, 170, 170, 170, 180, 180, 180, 180, 190, 190, 
                        190, 190, 200, 200, 200, 200, 10, 10, 10, 10, 20, 20, 20, 20, 30, 30, 30, 30, 40, 40, 40, 40, 
                        50, 50, 50, 50, 60, 60, 60, 60, 70, 70, 70, 70, 80, 80, 80, 80,
                        10, 10, 10, 10, 20, 20, 20, 20, 30, 30, 30, 30, 40, 40, 40, 40, 
                        50, 50, 50, 50, 60, 60, 60, 60, 70, 70, 70, 70, 80, 80, 80, 80, 
                        10, 10, 10, 10, 20, 20, 20, 20, 30, 30, 30, 30, 40, 40, 40, 40, 
